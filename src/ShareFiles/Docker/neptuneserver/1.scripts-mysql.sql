...
CREATE TABLE `AUTH_ORGANIZATION` (
    ...
    `welcome_logo` mediumtext NULL,
    `login_background` mediumtext NULL,
...
CREATE TABLE `AUTH_USER` (
    ...
    `PastHashPassword1` varchar(500) NULL,
    `PastHashPassword2` varchar(500) NULL,
    `PastHashPassword3` varchar(500) NULL,
    `PastHashPassword4` varchar(500) NULL,
    `PastHashPassword5` varchar(500) NULL,
    `PastHashPassword6` varchar(500) NULL,
    `PastHashPassword7` varchar(500) NULL,
    `PastHashPassword8` varchar(500) NULL,
    `PastHashPassword9` varchar(500) NULL,
    `PastHashPassword10` varchar(500) NULL,
...
CREATE TABLE `INSTANCE` (
    ...
    `GRPC_URL` varchar(500) NOT NULL,
    `UTC_TIME` bigint NOT NULL,
    `UTC_EXP_TIME` bigint NOT NULL,
    `SERVICE_ID` varchar(100) NULL,
    `EVENT_QUEUE_NAME` varchar(500) NULL,
    `COMMAND_QUEUE_NAME` varchar(500) NULL,
...
CREATE TABLE `LOG_INCOMING_QUEUE_MESSAGE` (
    ...
    `COMING_CONTENT` mediumtext NULL,
    `PROCESSING_ERROR` mediumtext NULL,
    `REQUEST_EXEC_STEP_ID` varchar(100) NULL,
    `RESPONSE_STATUS` varchar(100) NULL,
    `RESPONSE_OUTPUT` mediumtext NULL,
...
CREATE TABLE `LOG_RECEIVING_HTTP` (
    ...
    `RECEIVING_DATA` mediumtext NULL,
    `SENDING_DATA` mediumtext NULL,
...
CREATE TABLE `SERVICE_DEF` (
    ...
    `SERVICE_INSTANCE_TYPE` varchar(50) NOT NULL,
...
CREATE TABLE `WF_DEF` (
    ...
    `OpenAPITags` varchar(500) NULL,
    `OpenAPIResponse` mediumtext  NULL,
    `OpenAPIResponseSpec` mediumtext  NULL,
...
CREATE TABLE `WF_EXEC` (
    ...
    `TX_CONTEXT` mediumtext NOT NULL,
    `APPROVED_EXECUTION_ID` varchar(100) NULL,
    `SERVICE_INSTANCES` varchar(2000) NULL,
...
CREATE TABLE `WF_FIELD` (
    ...
    `NUM_RANGE` mediumtext NULL,
    `TEXT_MIN` mediumtext NULL,
    `TEXT_MAX` mediumtext NULL,
    `TEXT_RANGE` mediumtext NULL,
    `TEXT_MAXLENGTH` int NOT NULL,
    `DATE_MIN` decimal(65,30) NOT NULL,
    `DATE_MAX` decimal(65,30) NOT NULL,
    `DATE_RANGE` mediumtext NULL,
    `BASE64_ICON` mediumtext NULL,
    `OPENAPI_EXAMPLE` longtext NULL,
    `OPENAPI_DESCRIPTION` longtext NULL,
...
CREATE TABLE `WF_STEP_DEF` (
    ...
    `SERVICE_ID` varchar(100) NULL,
    `SENDING_TEMPLATE` mediumtext NULL,
    `SUCCESS_CONDITION` mediumtext NULL,
    ...
    `BASE64_ICON` mediumtext NULL,
    `SENDING_CONDITION` mediumtext NULL,
...
CREATE INDEX `IX_INSTANCE_SERVICE_ID` ON `INSTANCE` (`SERVICE_ID`);
...
VALUES ('20221026033538_v1', '6.0.10');
