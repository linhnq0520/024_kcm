...
/// </summary>
public partial class ApiNcbsCbsActivityView : ICoreAPIService
{
    /// <summary>
    /// AddActionError
    /// </summary>
    ...
    private JToken buildF8FromResponse(JToken packApi)
    {
        ...
        string step_fo = step_code + ";ACT_EXECUTE_POSTING;VOUCHER;POSTING_CSH_BMOV";
        ...
        if (data_response.ContainsKey(propertyName: "entry_journals") && data_response.SelectToken("entry_journals").Type != JTokenType.Null)
        {
            ...
            data_response["postings_debit"] = new_postings_debit;
            data_response["postings_credit"] = new_postings_credit;
        }
