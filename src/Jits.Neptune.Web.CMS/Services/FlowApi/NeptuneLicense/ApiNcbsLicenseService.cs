...
/// </summary>
public partial class ApiNcbsLicenseService : ICoreAPIService
{
    /// <summary>
    /// 
    /// </summary>
    ...
    {
        var rsPack = packApi.ToJObject();
        try
        {
            var executeResult = packApi.SelectToken("data").ToJArray();
            if (executeResult != null)
            {
                rsPack["data"] = Utils.Utils.BuildTableCodeForArray(executeResult, "service_code");
                return rsPack;
            }
        ...
        {
            // TODO
            System.Console.WriteLine("EXCEPTION BUILD RESPONSE LICENSE SERVICE==" + ex.StackTrace);
        }
        await Task.CompletedTask;
        return packApi;
    }
