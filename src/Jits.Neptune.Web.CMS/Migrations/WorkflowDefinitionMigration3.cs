...
namespace Jits.Neptune.Web.CMS.Migrations
{
    ...
    /// Bo Schema Migration
    /// </summary>
    [NeptuneMigration("2024/05/17 10:40:00:0000000", "WorkflowDefinition data 3", UpdateMigrationType.Data, MigrationProcessType.Update)]
    public class WorkflowDefinitionMigration3 : AutoReversingMigration
    {
        /// <summary>
        /// 
        /// </summary>
        ...
        public WorkflowDefinitionMigration3(INeptuneDataProvider dataProvider)
        {
        ...
        {
            string directoryPath = "./Migrations/SeedData/AccountingWorkflowDefinition.csv";
