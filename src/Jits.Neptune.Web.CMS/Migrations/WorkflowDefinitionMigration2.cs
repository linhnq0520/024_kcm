...
namespace Jits.Neptune.Web.CMS.Migrations
{
    ...
    /// Bo Schema Migration
    /// </summary>
    [NeptuneMigration("2024/05/02 14:48:00:0000000", "WorkflowDefinition data", UpdateMigrationType.Data, MigrationProcessType.Update)]
    public class WorkflowDefinitionMigration2 : AutoReversingMigration
    {
        /// <summary>
        /// 
        /// </summary>
        ...
        public WorkflowDefinitionMigration2(INeptuneDataProvider dataProvider)
        {
        ...
        {
            string directoryPath = "./Migrations/SeedData/AdminWorkflow.csv";
