...
namespace Jits.Neptune.Web.CMS.Migrations
{
    ...
    /// Bo Schema Migration
    /// </summary>
    [NeptuneMigration("2024/04/01 19:33:31:0000000", "Fo-CMS data", UpdateMigrationType.Data, MigrationProcessType.Update)]
    public class FoDataMigration : Migration
    {
        /// <summary>
        /// The data provider
        /// </summary>
        ...
        public FoDataMigration(INeptuneDataProvider dataProvider)
        {
        ...
        {
            var data = await Utils.Utils.ReadData<Fo>("FoData.json");

            await _dataProvider.Truncate<Fo>(false);
