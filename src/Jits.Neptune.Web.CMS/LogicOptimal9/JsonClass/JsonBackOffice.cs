...
public class JsonBackOffice : JsonHeader {
    ...
    public JsonBackOffice (JsonBackOfficeMapping clsJsonBackOfficeMapping = null) {
        ...
        } catch (Exception ex)
        {
            ...
            throw new NeptuneException("Error when mapping backOffice");
        }
    }
}
/// <summary>
...
public class JsonBackOfficeMapping : JsonHeaderMapping
{
    ...
    /// 
    /// </summary>
    public JsonBackOfficeMapping(JsonBackOffice clsJsonBackOffice = null)
    {
        try
        {
            if (clsJsonBackOffice != null)
            {
                ...
                {
                    S.Add(new JsonDataMapping(clsJsonData));
                }
