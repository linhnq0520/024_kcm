...
public class GlobalVariable
{
    ...
    /// 
    /// </summary>
    public static string ncbsCbsMode = "";
    ...
    /// 
    /// </summary>
    public static List<string> DatetimeFormat = new List<string> { "dd/MM/yyyy","dd/M/yyyy", "d/MM/yyyy", "d/M/yyyy", "dd/MM/yyyy HH:mm:ss", "dd/MM/yyyy HH:mm", "MM/dd/yyyy","yyyy/MM/dd","yyyy-MM-dd'T'",
                                            "dd-MM-yyyy", "MM-dd-yyyy", "yyyy-MM-dd", "yyyy-MM-dd'Z'",
                                            "dd/MM/yyyy hh:mm:ss tt", "yyyy-MM-dd'T'HH:mm:ss.ff", "yyyy-MM-dd'T'HH:mm:ss",
                                            "yyyy-MM-dd'T'HH:mm:ss.fff'Z'", "yyyy-MM-dd'T'HH:mm:ss", "d/M/YYYY H:m:s tt", "ddd MMM dd yyyy HH:mm:ss 'GMT'K '(Indochina Time)'"};
}
