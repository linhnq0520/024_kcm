...
/// </summary>
public partial class DesignGroupController : BaseController
{

    /// <summary>
    /// Ctor
    /// </summary>
    public DesignGroupController()
    { }
    ...
    public virtual async Task<IActionResult> Export(List<DesignGroupExportDataModel> listFields)
    {
        var file = await Utils.Utils.ExportData<DesignGroup, DesignGroupExportDataModel>(HttpContext.Request.Host.ToString(), listFields);
    ...
    public virtual async Task<IActionResult> UploadData(IFormFile file)
    {
        ...
        await Utils.Utils.UploadData<DesignGroup, DesignGroupExportDataModel>(utfString);
