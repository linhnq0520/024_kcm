...
/// </summary>
public partial class BoController : BaseController
{
    ...
    public virtual async Task<IActionResult> DownloadZip(List<BoExportDataModel> listFields)
    {
        var files = await Utils.Utils.ExportListFiles<Bo, BoExportDataModel>(HttpContext.Request.Host.ToString(), listFields);
        try
        {
            var zipName = $"Bo-{DateTime.Now.ToString("yyyy_MM_dd-HH_mm_ss")}.zip";
    ...
    [ProducesResponseType(typeof(string), StatusCodes.Status200OK)]
    [ProducesResponseType(typeof(string), StatusCodes.Status400BadRequest)]
    public virtual async Task<IActionResult> ExportToFiles(List<BoExportDataModel> listFields)
    {
        var files = await Utils.Utils.ExportListFiles<Bo, BoExportDataModel>(HttpContext.Request.Host.ToString(), listFields);
        try
        {
    ...
    [ProducesResponseType(typeof(string), StatusCodes.Status200OK)]
    [ProducesResponseType(typeof(string), StatusCodes.Status400BadRequest)]
    public virtual async Task<IActionResult> Export(List<BoExportDataModel> listFields)
    {
        var file = await Utils.Utils.ExportData<Bo, BoExportDataModel>(HttpContext.Request.Host.ToString(), listFields);
    ...
    public virtual async Task<IActionResult> UploadData(IFormFile file)
    {
        ...
        await Utils.Utils.UploadData<Bo, BoExportDataModel>(utfString);
