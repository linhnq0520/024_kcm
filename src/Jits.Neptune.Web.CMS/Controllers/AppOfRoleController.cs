...
/// </summary>
public partial class AppOfRoleController : BaseController
{

    /// <summary>
    /// Ctor
    /// </summary>
    public AppOfRoleController()
    { }
    ...
    public virtual async Task<IActionResult> Export(List<AppOfRoleExportDataModel> listFields)
    {

        var file = await Utils.Utils.ExportData<AppOfRole, AppOfRoleExportDataModel>(HttpContext.Request.Host.ToString(), listFields);
    ...
    public virtual async Task<IActionResult> UploadData(IFormFile file)
    {
        ...
        await Utils.Utils.UploadData<AppOfRole, AppOfRoleExportDataModel>(utfString);
