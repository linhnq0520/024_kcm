...
/// </summary>
public partial class DesignItemController : BaseController
{

    /// <summary>
    /// Ctor
    /// </summary>
    public DesignItemController()
    { }
    ...
    public virtual async Task<IActionResult> Export(List<DesignItemExportDataModel> listFields)
    {
        var file = await Utils.Utils.ExportData<DesignItem, DesignItemExportDataModel>(HttpContext.Request.Host.ToString(), listFields);
    ...
    public virtual async Task<IActionResult> UploadData(IFormFile file)
    {
        ...
        await Utils.Utils.UploadData<DesignItem, DesignItemExportDataModel>(utfString);
