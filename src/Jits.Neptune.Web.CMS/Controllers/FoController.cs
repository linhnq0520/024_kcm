...
/// </summary>
public partial class FoController : BaseController
{
    ...
    public virtual async Task<IActionResult> DownloadZip(List<FoExportDataModel> listFields)
    {
        var files = await Utils.Utils.ExportListFiles<Fo, FoExportDataModel>(HttpContext.Request.Host.ToString(), listFields);
        try
        {
            var zipName = $"Fo-{DateTime.Now.ToString("yyyy_MM_dd-HH_mm_ss")}.zip";
    ...
    [ProducesResponseType(typeof(string), StatusCodes.Status200OK)]
    [ProducesResponseType(typeof(string), StatusCodes.Status400BadRequest)]
    public virtual async Task<IActionResult> ExportToFiles(List<FoExportDataModel> listFields)
    {
        var files = await Utils.Utils.ExportListFiles<Fo, FoExportDataModel>(HttpContext.Request.Host.ToString(), listFields);
        try
        {
    ...
    [ProducesResponseType(typeof(string), StatusCodes.Status200OK)]
    [ProducesResponseType(typeof(string), StatusCodes.Status400BadRequest)]
    public virtual async Task<IActionResult> Export(List<FoExportDataModel> listFields)
    {
        var file = await Utils.Utils.ExportData<Fo, FoExportDataModel>(HttpContext.Request.Host.ToString(), listFields);
    ...
    public virtual async Task<IActionResult> UploadData(IFormFile file)
    {
        ...
        await Utils.Utils.UploadData<Fo, FoExportDataModel>(utfString);
