...
namespace Jits.Neptune.Web.CMS.Models
{
    ...
    /// 
    /// </summary>
    public class CrdCatalogueDefinitionResponse  : BaseNeptuneModel
    {   
     ...
     /// <summary>
     /// The crd account search response class
     /// </summary>
     /// <seealso cref="BaseNeptuneModel"/>
     public class CrdAccountSearchResponse : BaseNeptuneModel
    {
    ...
    /// 
    /// </summary>
        public class CrdIfcDenfinitionSearchResponse : BaseNeptuneModel
    {
